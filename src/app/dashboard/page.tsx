...
export default async function DashboardHomePage() {
  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <h2 className="text-xl font-bold uppercase">Participation Certificates</h2>
        <p className="mt-2 text-sm" style={{ color: "rgba(245, 230, 211, 0.8)" }}>
          Confirm your certificate name and download event participation certificates.
        </p>
        <Link className="mt-4 inline-block rounded-md border px-3 py-2 text-sm" style={{ borderColor: "rgba(212, 165, 116, 0.25)" }} href="/dashboard/pcertificates">
          Open Certificates
        </Link>
      </article>
